...
function Square (){
    ...
    const [streamer, setStreamer] = useState({
        profile_image_url: "https://www.sunjs.com/staticfile/ace_admin_v1.4.0/assets/avatars/profile-pic.jpg"
    })
    ...
    if(userToken === null){
    return(<Cuadro getToken={getUserToken} />) 
    }else{
    return (
        <div className="app-container">  
            <form onSubmit={request} >
            <input 
             defaultValue="heggart" 
             type="text"
             ref={formInput}
            />
...
render(
<Square />,  document.getElementById('myApp')
);
